    ...
    <div className="flex">
        ...
        <Page title="Criar projecto">
            <div className="flex flex-col justify-center items-center h-[100%] gap-14">
                ...
                <div id='createProjectDiv' className="flex justify-around items-center  w-[70%]">
                  <div data-aos="fade-right">
                    <CreateProjectForm/>
                  </div>

                  <div data-aos="flip-right">
                    <Image id="createProjectImg" src={"/assets/create-project-img.svg"} alt="Create-project-img" width={500} height={500}></Image>
                  </div>
                </div>
            </div>
        </Page>
